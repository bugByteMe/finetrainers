...
class WanPipelineInv(WanPipeline):
    def __init__(self,
        ...
        super().__init__(tokenizer=tokenizer, text_encoder=text_encoder, transformer=transformer, vae=vae, scheduler=scheduler)
    
    def _get_t5_prompt_embeds(
        self,
        prompt: Union[str, List[str]] = None,
        special_embedding: Optional[torch.Tensor] = None,
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            prompt_embeds = self._get_t5_prompt_embeds(
                prompt=prompt,
                special_embedding=special_embedding,
    ...
    def __call__(
        self,
        prompt: Union[str, List[str]] = None,
        special_embedding: torch.Tensor = None,
...
class WanModelSpecificationInv(WanModelSpecification):
    def __init__(
        self,
    ...
    def validation(
        ...
        prompt: str,
        special_embedding: torch.Tensor, 
